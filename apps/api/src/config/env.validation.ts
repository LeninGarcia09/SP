...
export const envValidationSchema = Joi.object({
  ...
  AZURE_AD_SERVICE_PRINCIPAL_ID: Joi.string().allow('').default(''),
  AZURE_AD_CLIENT_CERTIFICATE_BASE64: Joi.string().allow('').default(''),
  ...
  TENANT_DEFAULT_ROLES: Joi.string().allow('').default(''),
