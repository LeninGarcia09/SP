...
const ROLE_LABELS: Record<UserRole, string> = {
  [UserRole.GLOBAL_LEAD]: 'Global Lead',
  [UserRole.BIZ_OPS_MANAGER]: 'BizOps Manager',
  [UserRole.RESOURCE_MANAGER]: 'Resource Manager',
  [UserRole.PROGRAM_MANAGER]: 'Program Manager',
  [UserRole.PROJECT_LEAD]: 'Project Lead',
  [UserRole.PROJECT_PERSONNEL]: 'Personnel',
  [UserRole.INVENTORY_MANAGER]: 'Inventory Mgr',
  [UserRole.HR_ADMIN]: 'HR Admin',
};

const ROLE_COLORS: Record<UserRole, string> = {
  [UserRole.GLOBAL_LEAD]: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300',
  [UserRole.BIZ_OPS_MANAGER]: 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300',
  [UserRole.RESOURCE_MANAGER]: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300',
  [UserRole.PROGRAM_MANAGER]: 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-300',
  [UserRole.PROJECT_LEAD]: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300',
  [UserRole.PROJECT_PERSONNEL]: 'bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-300',
  [UserRole.INVENTORY_MANAGER]: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300',
  [UserRole.HR_ADMIN]: 'bg-pink-100 text-pink-800 dark:bg-pink-900/30 dark:text-pink-300',
};
